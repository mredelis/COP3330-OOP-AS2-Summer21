...
//        System.out.println(myList.get(0).keySet());
        Collections.sort(myList, (m1, m2) -> m1.get("last").compareTo(m2.get("last")));
...
//        System.out.println(myList.get(0).get("first"));
//
//        System.out.println(myList.get(0).get("last"));
//        System.out.println(myList.get(0).get("position"));
//        System.out.println(myList.get(0).get("date"));
